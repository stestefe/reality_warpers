...
public class DualTrapezoPrismWireframe : MonoBehaviour
{
    [System.Serializable]
    ...
    private void FindAndCacheEyeTransform()
    {
        ...
        {
            Debug.LogWarning("DualTrapezoPrismWireframe: Could not find CenterEyeAnchor. Frustums will not track camera.");
        }
    }
    ...
    // Public methods to query collision state
